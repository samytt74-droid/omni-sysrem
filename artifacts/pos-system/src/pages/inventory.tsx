                  ...
                  {summary?.lowStockItems?.length === 0 ? (
                    ...
                    summary?.lowStockItems?.map((p: any) => (
                      <tr key={p.id} className="hover:bg-rose-50/20">
                        ...
                        <td className="p-3 font-medium text-slate-800">{p.name}</td>
                        <td className="p-3 text-slate-500">{p.categoryName || "-"}</td>
                        <td className="p-3 font-bold text-rose-600">{p.stock ?? 0} {p.unitOfMeasure || "وحدة"}</td>
                        <td className="p-3 text-center">
            ...
            <div className="space-y-4 py-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 mt-1">
                  الرصيد الحالي بالمخزن: <span className="font-bold text-slate-800">{selectedProduct?.stock ?? 0} {selectedProduct?.unitOfMeasure || "وحدة"}</span>
                </p>
              </div>
